...
public class SelectorPlay2 : MonoBehaviour
{
    ...
    public void NextCharacter()
    {
        switch (CharacterInt)
        {
            case 1:
                ...
                break;
            case 2:
                PlayerPrefs.SetInt(selectedCharaterPlayer2, 3);
                ...
                break;
            case 3:
                PlayerPrefs.SetInt(selectedCharaterPlayer2, 4);
                ...
                break;
            case 4:
                PlayerPrefs.SetInt(selectedCharaterPlayer2, 5);
