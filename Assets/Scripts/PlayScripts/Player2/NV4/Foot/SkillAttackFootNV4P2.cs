...
public class SkillAttackFootNV4P2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad5) && !attacking && checkgrounded && !checksitdown && !checkdefense && NhanVat4a.Mana > 20 && !checkAttackFoot && !checkAttackHand)
        {
            NhanVat4a.Mana = NhanVat4a.Mana - 20;
            Debug.Log(NhanVat4a.Mana);
            attacking = true;
